...
template<IntervalType Interval>
bool is_vector2_inside_polygon(const Vector2<Interval>& vector2, const Polygon<Interval>& polygon) {
...
template<IntervalType Interval>
bool is_projected_vertex_inside_polygon_trivial(const Vector3<Interval>& vertex, const Interval& theta, const Interval& phi, const Polygon<Interval>& polygon) {
    const Vector2<Interval> projected_vertex = projection_trivial(vertex, theta, phi);
    return is_vector2_inside_polygon(projected_vertex, polygon);
}

template<IntervalType Interval>
bool is_projected_vertex_inside_polygon_combined(const Vector3<Interval>& vertex, const Interval& theta, const Interval& phi, const Polygon<Interval>& polygon) {
    const Vector2<Interval> projected_vertex = projection_combined(vertex, theta, phi);
    return is_vector2_inside_polygon(projected_vertex, polygon);
}

template<IntervalType Interval>
bool is_vector2_outside_polygon(const Vector2<Interval>& vector2, const Polygon<Interval>& polygon) {
...
template<IntervalType Interval>
bool is_projected_vertex_outside_polygon_trivial(const Vector3<Interval>& vertex, const Interval& theta, const Interval& phi, const Polygon<Interval>& polygon) {
    const Vector2<Interval> projected_vertex = projection_trivial(vertex, theta, phi);
    return is_vector2_outside_polygon(projected_vertex, polygon);
}

template<IntervalType Interval>
bool is_projected_vertex_outside_polygon_combined(const Vector3<Interval>& vertex, const Interval& theta, const Interval& phi, const Polygon<Interval>& polygon) {
    const Vector2<Interval> projected_vertex = projection_combined(vertex, theta, phi);
    return is_vector2_outside_polygon(projected_vertex, polygon);
}

template<IntervalType Interval>
bool is_projected_vertex_avoiding_polygon_advanced_fixed_theta(const Vector3<Interval>& vertex, const typename Interval::Number& theta, const Interval& phi, const Polygon<Interval>& polygon) {
...
template<IntervalType Interval>
bool is_projected_vertex_avoiding_edge_advanced_fixed_phi(const Vector3<Interval>& vertex, const Interval& theta, const typename Interval::Number& phi, const Edge<Interval>& edge) {
...
template<IntervalType Interval>
bool is_projected_vertex_avoiding_polygon_advanced_fixed_phi(const Vector3<Interval>& vertex, const Interval& theta, const typename Interval::Number& phi, const Polygon<Interval>& polygon) {
...
template<IntervalType Interval>
bool is_projected_vertex_outside_polygon_advanced(const Vector3<Interval>& vertex, const Interval& theta, const Interval& phi, const Polygon<Interval>& polygon) {
    if(!(theta.len() < Interval::pi() / 3)) {
