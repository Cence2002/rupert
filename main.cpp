...
//     const std::vector<Vector3<I>> plug = Polyhedron<I>::cube();
//     const std::vector<Vector3<I>> hole = Polyhedron<I>::cube();
//
//     Queue3 queue3;
//
...
int main() {
    ...
    MpfiInterval::set_print_precision(10);
    MpfiInterval::set_print_mode(IntervalPrintMode::MID_AND_RAD);
    std::cout << MpfiInterval::pi().sin().len() << std::endl;
    return 0;
}
